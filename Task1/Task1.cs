...
namespace AbstractFactory
{
    public class AbstractFactory
    {
        ...
        class MersedesEngine : Engine
        {
            public override void GetPower()
            {
                Console.WriteLine("Mersedes Engine 6.5");
            }
        }
        ...
        static void turnOnCar(ICarFactory factory)
        {
            var myCar = factory.CreateCar();
            myCar.Info();
            Engine myEngine = factory.CreateEngine();
            myEngine.GetPower();
        }
